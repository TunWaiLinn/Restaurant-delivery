    ...
    <div className="w-full h-auto min-h-screen flex justify-center items-center">
      <div className="w-[90%] md:w-[75%] border border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4">
                    ...
                    <button
                      ...
                      className="absolute bottom-3 right-3 p-3 rounded-full
                       bg-red-500 text-xl cursor-pointer outline-none
                        hover:shadow-lg duration-100 transition-all ease-in-out"
                      onClick={deleteImage}
                    >
        ...
        <div className="flex items-center w-full">
          <button
            type="button"
            className="bg-emerald-400 ml-0 md:ml-auto w-full md:w-auto rounded-lg py-2 px-12 border-none
             outline-none text-lg text-white font-semibold drop-shadow-sm hover:drop-shadow-lg"
            onClick={saveDetails}
          >
            Save
          </button>
