    ...
    <section className="w-full my-6" id="menu">
      <div className="w-full flex flex-col items-center justify-center">
        <p
          ...
          before:w-16 before:h-1 before:-bottom-2 before:left-0 before:bg-gradient-to-tr from-orange-400 to-orange-600
          ...
          {categories &&
            categories.map((category) => (
              <motion.div
                ...
                items-center hover:bg-red-600 justify-center`}
              >
                <div
